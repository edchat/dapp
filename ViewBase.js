		...
		return dcl(null, {
			...
			load: function () {
				...
				when(vcDef, function (controller) {
					if (controller) {
						// Here we need to setup the attributes for the view from the properites on the controller.
						// loop thru controller properties and add to _viewAttributeNames if not a function
