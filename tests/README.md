...
```
http://localhost/dapp/node_modules/intern/client.html?config=tests/client
```
...
```
cd ..\..\..
node dapp\node_modules\intern\runner.js config=dapp\tests\sauce.js
```
...
```
cd ..\..\..
node dapp\node_modules\intern\runner.js config=dapp\tests\local.js
```
