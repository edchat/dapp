define([
	...
	"delite/register",
	"dojo/Deferred",
	"dojo/text!dapp/tests/unit/simple2/app1.json",
	"dojo/text!dapp/tests/unit/simple2/app2.json",
	"dojo/text!dapp/tests/unit/simple2/app3.json",
	...
	var sample2Suite1 = {
		...
		"sample2Suite1 dapp simple2 test app status": function () {
			...
			handle = topic.subscribe("/app/status", function (status, appId) {
				if (appId = appName) {
					console.log(appId, ":simple2/Simple test in topic.subscribe for /app/status for [" +
